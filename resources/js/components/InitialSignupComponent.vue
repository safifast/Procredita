            ...
            <div class="card shadow overflow-hidden">
                <div class="card-body countainer">
                    <div class="row justify-content-end">
                        <div class="col-lg-2">
                            <span id="rate" class="color-blue font-weight-bold1">Interest Rate</span>
                            <br>
                            <span class="lead">per month</span>
                        </div>
                        <div  class="col-lg-1 color-blue font-weight-bold card bg-lightblue text-center">
